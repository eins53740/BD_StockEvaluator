...
def test_flowchart_generation():
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        checks = [
            ...
            (
                "Contains direct color values",
                "#" in flowchart_def and "fill:" in flowchart_def,
            ),
            ...
            (
                ...
                all(
                    ...
                    or line.strip() == ""
                    for line in flowchart_def.split("\n")
    ...
    if all_tests_passed:
        print(
            "✓ All test scenarios passed! Flowchart syntax generation is working correctly."
        )
    else:
    ...
    assert (
        all_tests_passed
    ), "Flowchart generation validation failed; see log for details."
